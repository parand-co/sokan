!function (e, t) {
    ...
    function p(e, n, r, i, o, a) {
        ...
        for (var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === at; c > u && (f || !s); u++) s = l[u](n, r, i), "string" == typeof s && (!f || a[s] ? s = t : (n.dataTypes.unshift(s), s = p(e, n, r, i, s, a)));
    ...
    var M = e.document, O = e.navigator, _ = e.location, H = function () {
        ...
        var r, i, o, a, s = function (e, t) {
            ...
            }, k = O.userAgent, S = Object.prototype.toString, A = Object.prototype.hasOwnProperty,
            L = Array.prototype.push, j = Array.prototype.slice, F = String.prototype.trim, D = Array.prototype.indexOf,
            _ = {};
    ...
    H.Callbacks = function (e) {
        ...
        var n, r, i, o, a, s = [], l = [], u = function (t) {
            var n, r, i, o;
            for (n = 0, r = t.length; r > n; n++) i = t[n], o = H.type(i), "array" === o ? u(i) : "function" === o && (!e.unique || !f.has(i)) && s.push(i)
        }, c = function (t, u) {
            for (u = u || [], n = !e.memory || [t, u], r = !0, a = i || 0, i = 0, o = s.length; s && o > a; a++) if (s[a].apply(t, u) === !1 && e.stopOnFalse) {
                n = !0;
                break
            }
            ...
            add: function () {
                ...
                if (s) for (var t = arguments, n = 0, i = t.length; i > n; n++) for (var l = 0; l < s.length && (t[n] !== s[l] || (r && o >= l && (o--, a >= l && a--), s.splice(l--, 1), !e.unique)); l++) ;
                return this
            }, has: function (e) {
                if (s) for (var t = 0, n = s.length; n > t; t++) if (e === s[t]) return !0;
                return !1
            }, empty: function () {
                return s = [], this
            }, disable: function () {
    ...
    H.extend({
        Deferred: function (e) {
            ...
            var r = P.call(arguments, 0), i = 0, o = r.length, a = Array(o), s = o,
                l = 1 >= o && e && H.isFunction(e.promise) ? e : H.Deferred(), u = l.promise();
            if (o > 1) {
                for (; o > i; i++) r[i] && r[i].promise && H.isFunction(r[i].promise) ? r[i].promise().then(n(i), l.reject, t(i)) : --s;
                s || l.resolveWith(l, r)
        ...
        removeData: function (e, t, n) {
            if (H.acceptData(e)) {
                ...
                if (t && (r = n ? l[u] : l[u].data)) {
                    ...
                    if (!(n ? j : H.isEmptyObject)(r)) return
                }
                if (!n && (delete l[u].data, !j(l[u]))) return;
        ...
        data: function (e, n) {
            ...
            if ("undefined" == typeof e) {
                if (this.length && (a = H.data(this[0]), 1 === this[0].nodeType && !H._data(this[0], "parsedAttrs"))) {
                    i = this[0].attributes;
                    for (var s = 0, l = i.length; l > s; s++) o = i[s].name, 0 === o.indexOf("data-") && (o = H.camelCase(o.substring(5)), F(this[0], o, a[o]));
    ...
    var I, $, R, X = /[\n\t\r]/g, z = /\s+/, V = /\r/g, U = /^(?:button|input)$/i,
        G = /^(?:button|input|object|select|textarea)$/i, J = /^a(?:rea)?$/i,
    ...
    var K = /^(?:textarea|input|select)$/i, Z = /^([^\.]*)?(?:\.(.+))?$/, ee = /\bhover(\.\S+)?\b/, te = /^key/,
        ne = /^(?:mouse|contextmenu)|click/, re = /^(?:focusinfocus|focusoutblur)$/,
        ie = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, oe = function (e) {
            var t = ie.exec(e);
    ...
    H.event = {
        ...
        dispatch: function (n) {
            ...
            var r, i, o, a, s, l, u, c, f, d, p = (H._data(this, "events") || {})[n.type] || [], h = p.delegateCount,
                m = [].slice.call(arguments, 0), g = !n.exclusive && !n.namespace, y = [];
    ...
    var le = /Until$/, ue = /^(?:parents|prevUntil|prevAll)/, ce = /,/, fe = /^.[^:#\[\.,]*$/,
        de = Array.prototype.slice, pe = H.expr.match.POS, he = {children: !0, contents: !0, next: !0, prev: !0};
    H.fn.extend({
        find: function (e) {
            var t, n, r = this;
    ...
    var me = "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ge = / jQuery\d+="(?:\d+|null)"/g, ye = /^\s+/,
        ve = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, be = /<([\w:]+)/,
        xe = /<tbody/i, Te = /<|&#?\w+;/, we = /<(?:script|style)/i, Ne = /<(?:script|object|embed|option|style)/i,
        Ce = new RegExp("<(?:" + me + ")", "i"), Ee = /checked\s*(?:[^=]|=\s*.checked.)/i, ke = /\/(java|ecma)script/i,
        Se = /^\s*<!(?:\[CDATA\[|\-\-)/, Ae = {
        ...
        text: function (e) {
            ...
            if (this[0]) {
                if (s = l && l.parentNode, i = H.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {fragment: s} : H.buildFragment(e, this, u), a = i.fragment, o = 1 === a.childNodes.length ? a = a.firstChild : a.firstChild, o) {
                    n = n && H.nodeName(o, "tr");
                    for (var c = 0, f = this.length, d = f - 1; f > c; c++) r.call(n ? N(this[c], o) : this[c], i.cacheable || f > 1 && d > c ? H.clone(a, !0, !0) : a)
                }
                u.length && H.each(u, g)
            }
            return this
        ...
        clone: function (e, t, n) {
            ...
            for (var o, a, s = [], l = 0; null != (a = e[l]); l++) if ("number" == typeof a && (a += ""), a) {
                if ("string" == typeof a) if (Te.test(a)) {
                    a = a.replace(ve, "<$1></$2>");
                    var u = (be.exec(a) || ["", ""])[1].toLowerCase(), c = Ae[u] || Ae._default, f = c[0],
                    ...
                    !H.support.leadingWhitespace && ye.test(a) && d.insertBefore(t.createTextNode(ye.exec(a)[0]), d.firstChild), a = d.childNodes
                } else a = t.createTextNode(a);
                var m;
                if (!H.support.appendChecked) if (a[0] && "number" == typeof(m = a.length)) for (o = 0; m > o; o++) v(a[o]); else v(a);
    ...
    var je, Fe, De, Me = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, _e = /([A-Z]|^ms)/g, He = /^-?\d+(?:px)?$/i,
        Be = /^-?\d/, Pe = /^([\-+])=([\-+.\de]+)/, qe = {position: "absolute", visibility: "hidden", display: "block"},
    ...
    H.fn.css = function (e, n) {
        ...
        H.cssHooks[t] = {
            get: function (e, n, r) {
                var i;
                return n ? 0 !== e.offsetWidth ? m(e, t, r) : (H.swap(e, qe, function () {
                    i = m(e, t, r)
                }), i) : void 0
            }, set: function (e, t) {
    ...
    var $e, Re, Xe = /%20/g, ze = /\[\]$/, Ve = /\r?\n/g, Ue = /#.*$/, Ge = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        ...
        Ye = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Qe = /^(?:GET|HEAD)$/, Ke = /^\/\//,
        Ze = /\?/, et = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, tt = /^(?:select|textarea)/i, nt = /\s+/,
        rt = /([?&])_=[^&]*/, it = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, ot = H.fn.load, at = {}, st = {},
        lt = ["*/"] + ["*"];
    try {
        $e = _.href
    } catch (ut) {
        ...
        ajax: function (e, n) {
            function r(e, n, r, a) {
                if (2 !== N) {
                    ...
                    if (e >= 200 && 300 > e || 304 === e) if (m.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (H.lastModified[i] = T), (w = C.getResponseHeader("Etag")) && (H.etag[i] = w)), 304 === e) E = "notmodified", f = !0; else try {
            ...
            var i, o, a, s, l, f, d, h, m = H.ajaxSetup({}, n), g = m.context || m,
                ...
                b = H.Callbacks("once memory"), x = m.statusCode || {}, T = {}, w = {}, N = 0, C = {
                    readyState: 0, setRequestHeader: function (e, t) {
                        ...
                        var n;
                        if (2 === N) {
                            if (!a) for (a = {}; n = Ge.exec(o);) a[n[1].toLowerCase()] = n[2];
                            n = a[e.toLowerCase()]
                        }
                        return n === t ? null : n
            ...
            if (v.promise(C), C.success = C.done, C.error = C.fail, C.complete = b.add, C.statusCode = function (e) {
                ...
                return this
            }, m.url = ((e || m.url) + "").replace(Ue, "").replace(Ke, Re[1] + "//"), m.dataTypes = H.trim(m.dataType || "*").toLowerCase().split(nt), null == m.crossDomain && (f = it.exec(m.url.toLowerCase()), m.crossDomain = !(!f || f[1] == Re[1] && f[2] == Re[2] && (f[3] || ("http:" === f[1] ? 80 : 443)) == (Re[3] || ("http:" === Re[1] ? 80 : 443)))), m.data && m.processData && "string" != typeof m.data && (m.data = H.param(m.data, m.traditional)), p(at, m, n, C), 2 === N) return !1;
            if (d = m.global, m.type = m.type.toUpperCase(), m.hasContent = !Qe.test(m.type), d && 0 === H.active++ && H.event.trigger("ajaxStart"), !m.hasContent && (m.data && (m.url += (Ze.test(m.url) ? "&" : "?") + m.data, delete m.data), i = m.url, m.cache === !1)) {
                var E = H.now(), k = m.url.replace(rt, "$1_=" + E);
                m.url = k + (k === m.url ? (Ze.test(m.url) ? "&" : "?") + "_=" + E : "")
            }
    ...
    var mt, gt, yt, vt, bt = {}, xt = /^(?:toggle|show|hide)$/, Tt = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,
        wt = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    H.fn.extend({
        show: function (e, t, n) {
            var o, a;
            if (e || 0 === e) return this.animate(i("show", 3), e, t, n);
            for (var s = 0, l = this.length; l > s; s++) o = this[s], o.style && (a = o.style.display, !H._data(o, "olddisplay") && "none" === a && (a = o.style.display = ""), "" === a && "none" === H.css(o, "display") && H._data(o, "olddisplay", r(o.nodeName)));
            for (s = 0; l > s; s++) o = this[s], o.style && (a = o.style.display, ("" === a || "none" === a) && (o.style.display = H._data(o, "olddisplay") || ""));
            return this
        }, hide: function (e, t, n) {
            if (e || 0 === e) return this.animate(i("hide", 3), e, t, n);
            for (var r, o, a = 0, s = this.length; s > a; a++) r = this[a], r.style && (o = H.css(r, "display"), "none" !== o && !H._data(r, "olddisplay") && H._data(r, "olddisplay", o));
            ...
            function o() {
                ...
                var t, n, i, o, s, l, u, c, f, d = H.extend({}, a), p = 1 === this.nodeType,
                    h = p && H(this).is(":hidden");
                d.animatedProperties = {};
                for (i in e) {
                    if (t = H.camelCase(i), i !== t && (e[t] = e[i], delete e[i]), n = e[t], H.isArray(n) ? (d.animatedProperties[t] = n[1], n = e[t] = n[0]) : d.animatedProperties[t] = d.specialEasing && d.specialEasing[t] || d.easing || "swing", "hide" === n && h || "show" === n && !h) return d.complete.call(this);
                ...
                for (i in e) o = new H.fx(this, d, i), n = e[i], xt.test(n) ? (f = H._data(this, "toggle" + i) || ("toggle" === n ? h ? "show" : "hide" : 0), f ? (H._data(this, "toggle" + i, "show" === f ? "hide" : "show"), o[f]()) : o[n]()) : (s = Tt.exec(n), l = o.cur(), s ? (u = parseFloat(s[2]), c = s[3] || (H.cssNumber[i] ? "" : "px"), "px" !== c && (H.style(this, i, (u || 1) + c), l = (u || 1) / o.cur() * l, H.style(this, i, l + c)), s[1] && (u = ("-=" === s[1] ? -1 : 1) * u + l), o.custom(l, u, c)) : o.custom(l, n, ""));
                return !0
            }
        ...
        update: function () {
            ...
            }, i() && H.timers.push(i) && !yt && (yt = setInterval(s.tick, s.interval))
        }, show: function () {
            ...
            var t, n, r, i = vt || a(), o = !0, s = this.elem, l = this.options;
    ...
    "getBoundingClientRect" in M.documentElement ? H.fn.offset = function (e) {
        ...
        if (!t || !H.contains(a, r)) return t ? {top: t.top, left: t.left} : {top: 0, left: 0};
        var s = o.body, l = n(o), u = a.clientTop || s.clientTop || 0, c = a.clientLeft || s.clientLeft || 0,
            f = l.pageYOffset || H.support.boxModel && a.scrollTop || s.scrollTop,
            d = l.pageXOffset || H.support.boxModel && a.scrollLeft || s.scrollLeft, p = t.top + f - u,
            h = t.left + d - c;
        return {top: p, left: h}
