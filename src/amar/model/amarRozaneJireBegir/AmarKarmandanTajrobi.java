...
public class AmarKarmandanTajrobi implements Serializable {


    private long id;
    private int nEdeKol;
    //motafareghe//
    private int nMorakhasi;
    private int nBastari;
    private int nNahast;
    private int nFarar;
    private int nBazdasht;
    private int nMontazerBekhedmat;
    private int nMamorAzEde;
    // \ //


    private int nJameMotafareghe;
    private int nMamorBeEde;
    private int nJameHazer;



    //negahbani//
    private int nSobhane;
    private int nNahar;
    private int nSham;
